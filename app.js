...
function detectAppleDevice(clientInfo) {
    const appleDevices = [
        ...
        // iPad
        { model: 'iPad Pro 12.9-inch (6th generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 11-inch (4th generation)', width: 834, height: 1194, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Air (5th generation)', width: 820, height: 1180, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad mini (6th generation)', width: 744, height: 1133, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad (10th generation)', width: 820, height: 1180, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad Pro 12.9-inch (5th generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 11-inch (3rd generation)', width: 834, height: 1194, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Air (4th generation)', width: 820, height: 1180, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad (9th generation)', width: 810, height: 1080, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad mini (5th generation)', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad (8th generation)', width: 810, height: 1080, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad (7th generation)', width: 810, height: 1080, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad Pro 12.9-inch (4th generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 11-inch (2nd generation)', width: 834, height: 1194, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Air (3rd generation)', width: 820, height: 1180, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad mini (5th generation)', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad (6th generation)', width: 810, height: 1080, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad Pro 12.9-inch (3rd generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 11-inch (1st generation)', width: 834, height: 1194, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 10.5-inch', width: 834, height: 1112, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 12.9-inch (2nd generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 9.7-inch', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Pro 12.9-inch (1st generation)', width: 1024, height: 1366, pixelRatio: 2, dynamicIsland: false, isProMotion: true },
        { model: 'iPad Air 2', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad Air', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad mini 4', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad mini 3', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad mini 2', width: 768, height: 1024, pixelRatio: 2, dynamicIsland: false, isProMotion: false },
        { model: 'iPad (5th generation)', width: 810, height: 1080, pixelRatio: 2, dynamicIsland: false, isProMotion: false }
    ];
